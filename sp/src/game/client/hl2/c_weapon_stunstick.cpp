...
// Billyclub Variant
//-----------------------------------------------------------------------------
class CWeaponBillyclub : public CWeaponStunStick {
	DECLARE_CLASS(CWeaponBillyclub, CWeaponStunStick);
	DECLARE_SERVERCLASS();
};
...
// Shovel Variant
//-----------------------------------------------------------------------------
class CWeaponShovel : public CWeaponStunStick {
	DECLARE_CLASS(CWeaponShovel, CWeaponStunStick);
	DECLARE_SERVERCLASS();
};
...
// Nightstick Variant
//-----------------------------------------------------------------------------
class CWeaponNightstick : public CWeaponStunStick {
	DECLARE_CLASS(CWeaponNightstick, CWeaponStunStick);
	DECLARE_SERVERCLASS();
};
