...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT(AE_WPN_RELOAD, AE_TYPE_CLIENT | AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_WPN_DRAWN, AE_TYPE_CLIENT | AE_TYPE_SERVER);
...
#endif
	//kick anim event #1
	REGISTER_SHARED_ANIMEVENT( AE_KICKATTACK, AE_TYPE_CLIENT | AE_TYPE_SERVER );
}