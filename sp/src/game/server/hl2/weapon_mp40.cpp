...
Vector CWeaponMP40::m_vecBulletSpread;
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponMP40::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponMP40::WeaponRangeAttack2Condition( float flDot, float flDist )
{
