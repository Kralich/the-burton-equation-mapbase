...
public:
	...
	float	GetFireRate( void ) { return GetTBEWpnData().m_flFireRate; }	// 13.3hz
...
//-----------------------------------------------------------------------------
void CWeaponMP7::Equip( CBaseCombatCharacter *pOwner )
{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponMP7::GetPrimaryAttackActivity( void )
{
	if ( m_nShotsFired < 2 )
...
float CWeaponMP7::GetDamageOverride()
{
	return sk_npc_dmg_mp7.GetFloat();
}

float CWeaponMP7::GetPlayerDamageOverride()
{
	return sk_plr_dmg_mp7.GetFloat();
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMP7::AddViewKick( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponMP7::SecondaryAttack( void )
{
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponMP7::WeaponRangeAttack2Condition( float flDot, float flDist )
{
